...
if page == "ℹ️ 시스템 정보":
    ...
    info_data = {
        ...
        "값": [
            ...
            "BFS max_depth=3 / Neo4j / nodes 2,542 / edges 6,889",
            "OWL / Owlready2",
            "0.3 (grid search 0.1~0.5)",
            "577 교수 / 60 학과 / 1,505 과목 / 400 프로젝트 / 1,037 문서",
            "5,000 쌍 (Simple 40% / Multi-hop 35% / Conditional 25%)",
    ...
    with tab_bench:
        ...
        with bs2:
            ...
            st.markdown(
                ...
                '2위(HybridRAG) 대비 F1 +6.3%, EM +10.0%, Faithfulness +8.6% 향상'
                '</div>',
                unsafe_allow_html=True,
            )
        ...
        with tc2:
            st.markdown(
                ...
                'Graph RAG의 BFS 탐색이 핵심이며, Vector-Only 대비 <b>+216.7%</b> 개선.<br>'
        ...
        with tc3:
            st.markdown(
                ...
                'Ontology RAG의 규칙 기반 추론이 핵심이며, Vector-Only 대비 <b>+119.5%</b> 개선.<br>'
        ...
        st.markdown("")
        st.info(
            "💡 **핵심 인사이트**: Multi-hop 질의에서 +216.7%라는 극적인 개선은 "
            "Graph RAG의 BFS 3-hop 탐색이 엔티티 간 관계를 정확히 추적하기 때문입니다. "
            "Conditional 질의의 +119.5% 개선은 Ontology RAG의 OWL 규칙 기반 필터링 덕분이며, "
...
# ══════════════════════════════════════════════════════════════
    ...
    with fc1:
        st.markdown(
            ...
            '<b style="color:#D85A30;">(A) → (B): +5.1% F1 향상</b><br>'
        ...
        st.markdown(
            '<div style="background:rgba(29,158,117,0.12);border-radius:8px;padding:16px;'
            'border-left:4px solid #1D9E75;">'
            '<b style="color:#1D9E75;">(B) → (C): Multi-hop EM +3.0%p</b><br>'
    ...
    with fc2:
        st.markdown(
            ...
            '<span style="font-size:13px;">Full DWA 대비 균등 가중치는 F1이 7.1% 하락하며, '
    ...
    st.success(
        "🏆 **결론**: DWA는 Multi-hop 질의에서 EM을 0.87 → 0.95로 **+9.2%** 향상시켰고, "
        "Conditional 질의에서 0.83 → 0.93으로 **+12.0%** 향상시켰습니다. "
